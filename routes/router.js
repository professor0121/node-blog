const { getHome, getNewForm, createPost, getSinglePost, serveStatic,getAllPosts } = require('../controllers/postController');
...
module.exports = (req, res) => {
  ...
  if (req.url.startsWith('/archive') && req.method === 'GET') return getAllPosts(req, res);
